  ...
  return (
    <>
      <PageHero
        ...
        highlightedWord={order.orderNumber}
        subtitle={`Placed ${format(new Date(order.createdAt), 'd MMM yyyy')}`}>
      ...
      <Container className="py-10 md:py-14">
        ...
        <MotionReveal className="rounded-2xl border border-border bg-white p-5 shadow-sm sm:p-6">
