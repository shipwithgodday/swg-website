...
export default function AdminEmailsPage() {
  ...
  if (!editor) {
    return <div className="text-zinc-500">Loading editor…</div>;
  }
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-[#00365D] bg-opacity-90 shadow-lg rounded-lg p-4 sm:p-6">
          ...
          <div className="border border-white/20 rounded-lg overflow-hidden">
            ...
            <EditorContent
              editor={editor}
              className="prose max-w-none bg-[#00365D] bg-opacity-90"
            />
          </div>
        ...
        <div className="bg-[#00365D] bg-opacity-90 shadow-lg rounded-lg p-4 sm:p-6">
          ...
          <div className="border border-white/20 rounded-lg p-4 max-h-[300px] overflow-y-auto bg-[#00365D] bg-opacity-90">
            {emails.length === 0 ? (
