...
function SignUp() {
  return (
    <section className="text-white my-16 md:my-24 lg:my-32">
      <Container className="bg-gradient-to-r from-[#00254F] to-[#00365D] rounded-3xl py-8 md:py-16 px-4 relative overflow-hidden">
        <div className="max-w-5xl mx-auto flex flex-col items-center justify-center relative z-10">
          ...
          <p className="text-center text-lg md:text-xl font-light mt-4 text-primary italic">
